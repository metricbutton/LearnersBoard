...
namespace Learner_s_Board
{
    public partial class viewcertificates : System.Web.UI.Page
    {
        ...
        void updateGridView()
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT document_id,learner_username,learner_fullname,date,type,event_name from certificate_master_tbl where learner_username='" + Session["learner_username"].ToString() + "' and status='Approved'; ", con);
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT document_path from certificate_master_tbl where document_id='" + TextBox2.Text.Trim() + "';", con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
